...
<?php
$cadenas = ["te","patata","cebolla","sal","pimienta","agua"];
$tamaño = [];

foreach ($cadenas as $cadena) {
    array_push($tamaño, strlen($cadena));
    
}

echo "<br>El string más corto es ". min($tamaño) ." y el string más largo es " . max($tamaño) . ".";
?>
